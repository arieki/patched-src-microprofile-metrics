...
import org.eclipse.microprofile.metrics.tck.metrics.TimedMethodBean3;
...
public class TimerInjectionBeanTest {
    ...
    @Inject
    @Metric(absolute = true, name = "org.eclipse.microprofile.metrics.tck.metrics.TimedMethodBean3.timedMethod")
    private Timer timer;
